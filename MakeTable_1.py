...
#     # Return mean and std as a dictionary
#     return mean, std
...
#     # Include calculations for Accuracy, Precision, and Recall if they are part of your metrics_list
#     for metrics_list, f2_list, model_name in zip(
#         [KM_metrics_list, SVM_metrics_list, RF_metrics_list],
#         [KM_f2_list, SVM_f2_list, RF_f2_list], 
#         ['K-Means', 'SVM', 'Random Forest']):
...
#         # Assuming you have a function to calculate means and stds for Accuracy, Precision, and Recall
...
# This function will need to be called with the actual lists of metrics generated by your model evaluations.


# Usage:
# Call this function with your actual KM_metrics_list, KM_f2_list, etc. to get the formatted results.
